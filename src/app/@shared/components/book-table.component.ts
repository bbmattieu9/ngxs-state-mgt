  ...
  <tbody>
    @for (row of basicTable.data; track row) {
      <tr>
        ...
        <td nzAlign="center">
          <nz-icon class="tbl__icon" nzType="folder-open" nzTheme="outline" (click)="view.emit(row)"></nz-icon>
          <nz-divider nzType="vertical"></nz-divider>
          <nz-icon class="tbl__icon" nzType="delete" nzTheme="outline" (click)="delete.emit(row.id)"></nz-icon>
          <nz-divider nzType="vertical"></nz-divider>
